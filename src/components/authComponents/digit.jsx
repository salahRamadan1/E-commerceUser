...
export default function Digit() {
    ...
    return (
        <>
            ...
            < div id='auth' className='form   text-center mt-5 pt-5 border border-1  w-75 mx-auto shadow-lg pb-2'>
                ...
                <form onSubmit={handleVerfiy}>
                    {success && <Alert severity='success' sx={{ width: "90%", marginX: "auto" }}>success</Alert>}
